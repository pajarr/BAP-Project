...
<div class="center-wrapper">
	...
	<div class="bag-product">
		<div class="image">
			<img src="../../gambar/wak doyok.jpg" class="product-image">
		</div>
		...
		<div class="description">
			...
			<p class="description-text">
				Pomade asal Negeri Jiran ini adalah pomade water based. Untuk ketahanannya nggak perlu diragukan lagi. Selain itu, pomade ini mengandung minyak zaitun, minyak jojoba, dan minyak buah limau yang akan membuat rambut kamu tetap sehat.
			</p>
