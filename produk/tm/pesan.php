...
<div class="center-wrapper">
	...
	<div class="bag-product">
		<div class="image">
			<img src="../../gambar/tm pomade.jpg" class="product-image">
		</div>
		<form action="order.php">
		<div class="description">
			<p class="product-code small muted">Id: 234786543</p>
			<h1>Tm Pomade</h1>
			<p class="description-text">
				TM pomade adalah minyak rambut yang memiliki kualitas unggulan. Salah satu produk unggulan mereka adalah TM Pomade – Leci yang memiliki aroma manis serta tekstur yang soft. Pomade ini bisa menjadi salah satu pilihan pomade kamu
			</p>
