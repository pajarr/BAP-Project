...
<div class="center-wrapper">
	...
	<div class="bag-product">
		<div class="image">
			<img src="../../gambar/js sloane.jpg" class="product-image">
		</div>
		<form action="order.php">
		<div class="description">
			<p class="product-code small muted">Id: 234572892</p>
			<h1>Js Sloane</h1>
			<p class="description-text">
				Pomade berbasis ini cukup berbeda dari pomade berbasis air lainnya, warnanya tidak transparan yang membuatnya tidak terlihat seperti gel.
			</p>
